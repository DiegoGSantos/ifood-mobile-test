...
class UserDetailViewModelFactory(private val repository: UserDetailRepository,
                                 private val sentimentRepository: TweetSentimentRepository,
    ...
    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(UserDetailViewModel::class.java)) {
            return UserDetailViewModel(repository, sentimentRepository, processScheduler, androidScheduler) as T
        }
